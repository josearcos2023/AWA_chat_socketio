...
io.on('connection',  socket => {
	// cuando el cliente emite el evento 'sendchat' se ejecuta el evento 'updatechat' que actualizará la vista del chat
	// este enviará como parámetros, el username y el parámetro 'data'
